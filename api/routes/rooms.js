...
router.put('/rooms/:id', requireJWT, (req, res) => {
  ...
  // If the booking is a recurring booking
    ...
    let bookingDateTracker = momentTimezone(firstBooking.bookingStart)
    ...
    let lastBookingDate = momentTimezone(firstBooking.recurring[0])
    ...
    for (let i = 0; i < bookingsInRange; i++) {
      ...
      if (proposedBookingDateStart.day() !== 0) {
        ...
        let firstBookingEndDate = momentTimezone(firstBooking.bookingEnd)
